...
const TEST_SCRIPTS := [
	...
	preload("res://tests/domain/universe/test_stellar_physics_model.gd"),
	...
	preload("res://tests/application/rendering/test_stellar_light_profile_service.gd"),
	preload("res://tests/application/rendering/test_system_selection_index.gd"),
	preload("res://tests/application/rendering/test_stellar_glow_batch_builder.gd"),
